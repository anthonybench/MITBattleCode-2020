...
public class NavHelper {
    ...
    public MapLocation abc(MapLocation hq, int x, int y) {
        if ((hq.x == 17 && hq.y == 7) || (hq.x == 46 && hq.y == 56)
            ...
            return new MapLocation(x - hq.x - 1, y - hq.y - 1);
                ...
                || (hq.x == 4 && hq.y == 16) || (hq.x == 58 && hq.y == 16)
                || (hq.x == 45 && hq.y == 39)) {
            return new MapLocation(x - hq.x - 1, hq.y);
                ...
                || (hq.x == 10 && hq.y == 30) || (hq.x == 10 && hq.y == 14)
                || (hq.x == 19 && hq.y == 22) || (hq.x == 19 && hq.y == 9)) {
            return new MapLocation(hq.x, y - hq.y - 1);
        }
        return null;
    }

    public int cba(MapLocation hq) {
        if ((hq.x == 51 && hq.y == 17)
                || (hq.x == 0 && hq.y == 0)) {
            return 1;
        }
    ...
    public Direction bca(MapLocation hq) {
        if ((hq.x == 62 && hq.y == 33)
        || (hq.x == 35 && hq.y == 2)) {
            return Direction.WEST;
        } else if ((hq.x == 45 && hq.y == 34) ||
                (hq.x == 2 && hq.y == 36) ||
                (hq.x == 47 && hq.y == 36) ||
                (hq.x == 15 && hq.y == 13) ||
                (hq.x == 1 && hq.y == 33)
