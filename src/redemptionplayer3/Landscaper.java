...
//            }
            ...
            } else if (rc.getLocation().distanceSquaredTo(enemyHqLoc) < 8 && tryMoveToEnemyHQTurns >= 10) {
...
//                    goTo(ranDir);
    ...
    public boolean outerRushLandscaperCanDig(MapLocation mapLoc) throws GameActionException {
        ...
        System.out.println(locationOccupiedWithSameTeamRobot(mapLoc));
